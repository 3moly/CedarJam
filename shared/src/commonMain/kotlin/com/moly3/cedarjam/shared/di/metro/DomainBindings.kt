...
import com.moly3.cedarjam.shared.di.PlatformAndroidContext
import com.moly3.cedarjam.shared.repository.getJvmBrowserService
import com.moly3.cedarjam.shared.repository.getUtilsService
import com.moly3.cedarjam.shared.service.ImageTransform
...
object DomainBindings {
    ...
    fun provideSqlStorageFactory(
        ...
        SqlStorageFactory { workspacePath ->
            createSqlStorage(
    ...
    @SingleIn(AppScope::class)
    @Provides
    fun provideIImageTransform(): IImageTransform =
        ImageTransform()

    @SingleIn(AppScope::class)
    @Provides
    fun provideIJvmBrowserService(): IJvmBrowserService =
        getJvmBrowserService()

    @SingleIn(AppScope::class)
    @Provides
    fun provideIUtilsService(): IUtilsService =
        getUtilsService()
}
